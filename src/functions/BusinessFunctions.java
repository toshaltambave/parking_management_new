...
public class BusinessFunctions {
	...
	public void revokeUser(WebDriver driver, String userName) {
		...
		new Select(driver.findElement(By.id(prop.getProperty("Drp_Dwn_Select_Search_Type_Revoke"))))
				.selectByVisibleText("UserName");
		System.out.printf("USERNAME: " + userName);
		new Select(driver.findElement(By.id(prop.getProperty("Drp_Dwn_Select_User_Revoke"))))
				.selectByVisibleText(userName);
	...
	public void addParkingArea(WebDriver driver, String AreaName, String PermitType, String FloorNo, String SpotsNo) {
		...
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Area_Error"))).getAttribute("value")
				.equals("Please correct the following errors"));
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Area_Name_Error"))).getAttribute("value")
				.equals("This field is mandatory."));
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Floor_Number_Error"))).getAttribute("value")
				.equals("This field is mandatory."));
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Spot_Number_Error"))).getAttribute("value")
				.equals("This field is mandatory."));
		driver.findElement(By.id(prop.getProperty("Btn_Parking_Area_Save"))).click();
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Area_Exception"))).getText()
				.equals("Add Area(s) to the list."));
		...
		new Select(driver.findElement(By.id(prop.getProperty("Txt_Parking_Area_PermitType"))))
				.selectByVisibleText(PermitType);
		...
		driver.findElement(By.id(prop.getProperty("Btn_Parking_Area_AddList"))).click();
		driver.findElement(By.id(prop.getProperty("Btn_Parking_Area_Save"))).click();
		assertTrue(driver.findElement(By.id(prop.getProperty("Txt_Parking_Add_Success"))).getText()
				.equals("Area(s) added successfully."));
