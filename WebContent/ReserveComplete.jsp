				                ...
				                <table class="table table-hover">
				                    ...
				                    <tbody>
				                        ...
				                        <tr>
				                            ...
				                            <td class="col-md-8"><input type="number" class="form-control" name="cardNumber" placeholder="Valid Card Number"
                                required autofocus /></td>
				                        </tr>
				                        <tr>
				                            <td class="col-md-9"><em>Card Type</em></h4></td>
				                            <td class="col-md-1 text-center"><select class="form-control" name="cardType">
				                        ...
				                        <tr>
				                            <td class="col-md-9"><em>Expiry</em></h4></td>
				                            <td class="col-md-1 text-center">
				                            <div class="col-xs-6 col-lg-6 pl-ziro">
                                    			<input type="text" class="form-control" name="expityMonth" placeholder="MM" required />
                                    			<input type="text" class="form-control" name="expityYear" placeholder="YY" required />
                                			</div>
                                    		</td>
				                        </tr>
				                        <tr>
				                            <td class="col-md-9">CVV</td>
				                            <td class="col-md-1 text-center"><input type="password" class="form-control" name="cvvCode" placeholder="CV" required /></td>
				                        </tr>
				                    </tbody>
				                </table>
