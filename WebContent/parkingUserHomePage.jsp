...
<div class="alert alert-danger" role="alert"> Your Account has been revoked Please Contact Manager.</div>
</c:if>
<c:if test="${isMax eq true}">
<div class="alert alert-danger" role="alert"> Only 3 Reservations allowed in a day.</div>
</c:if>
<div class="row">
...
<div class="col"><a class="btn btn-info" href="${pageContext.request.contextPath}/ModifyReservationController?action=editReservation">Edit a reservation</a> </div> <br> <!-- TODO TOSHAL -->
